...
STATE='IMPLEMENTATION_REVIEW'; READY='READY_FOR_VERIFICATION'; NEXT='VERIFICATION'
...
def validate(i,o):
 ...
 allowed={'self_review':{'PASS'},'technical_review':{'PASS'},'security_review':{'PASS','NOT_APPLICABLE'},'breaking_review':{'PASS','NOT_APPLICABLE'}}
 invalid=[z for z in i['tracks'] if z['status'] not in allowed.get(z['track'],set())|{'CHANGES_REQUIRED','BLOCKED'}]
 if invalid:x.append('track status is not valid for implementation review')
